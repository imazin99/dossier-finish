...
import { PageContainer, SectionTitle, GlassCard, BulletList, PrimaryButton, SecondaryButton } from "@components/ui";
...
export function EndingScreen() {
  ...
  return (
    <PageContainer>
      <div className="spotlight-glow flex flex-col items-center gap-4 pb-2 pt-4 text-center">
      ...
      {killerExplanation && (
        <div className="flex flex-col gap-3">
          ...
          <GlassCard>
            <p className="text-sm leading-relaxed text-text-secondary">{killerExplanation[language]}</p>
          </GlassCard>
        </div>
      )}
